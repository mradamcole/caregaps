...
abcFHIRGridInstantiate = () => {
    //Position the downloadTable and get rid of the horizontal scroll bar
    let container = document.getElementById("abcFHIRGridContainer")
    container.style.position = "absolute";
    container.style.left = document.getElementById("PatientSearch").offsetLeft;
    container.style.top = document.getElementById("PatientSearch").offsetTop + document.getElementById("PatientSearch").clientHeight + 2;
    container.style.width = getParam(abcFHIRGridParams, abcFHIRGridParams.template, "width");
    container.style.height = getParam(abcFHIRGridParams, abcFHIRGridParams.template, "height");
    ...
    container = document.getElementById("abcFHIRGridContainerLoading")
    container.style.position = "absolute";
    container.style.left = document.getElementById("PatientSearch").offsetLeft;
    container.style.top = document.getElementById("PatientSearch").offsetTop + document.getElementById("PatientSearch").clientHeight + 28;
    container.style.width = getParam(abcFHIRGridParams, abcFHIRGridParams.template, "width");
